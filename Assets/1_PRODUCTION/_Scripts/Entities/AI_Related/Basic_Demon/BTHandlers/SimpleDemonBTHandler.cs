namespace akb.Entities.AI.Implementations.Simple_Demon
{
     ...
     * constructing and updating the SimpleDemon BehaviourTree.
     */
    public class SimpleDemonBTHandler : AI_EntityBTHandler
    {
        BehaviourTree entryBT;
        BehaviourTree movePattern;
        BehaviourTree attackPattern;

        public SimpleDemonBTHandler(SimpleDemon ai_entity, INodeData nodeData)
        {
